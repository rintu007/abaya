            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						...
						<a href="<?php echo base_url().'product?view=list'; ?>">
							<div class="pull-left"><i class="fa  fa-th-list mr-5"></i><span class="right-nav-text">Products</span></div>
						</a>
...
?>
		       				<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6" id="ItemRow<?php echo $item['ProductID'];?>">
									...
									<div class="panel-wrapper collapse in">
										<div class="panel-body pa-0">
											<article class="col-item">
												<div class="photo" >
													<div class="options">
														<a href="#" onclick="DeleteItem(<?php echo $item['ProductID'];?>);" class="font-18 txt-grey pull-left sa-warning"><i class="zmdi zmdi-close"></i></a>
													</div>
													
													<a href="<?php echo base_url().'product/edit/'.$item['ProductID']; ?>">
														<img style="width: 180px;height: 180px;" src="<?php echo $Photo; ?>"  class="img-responsive" alt="Product Image" /> </a>
												</div>
												<div class="info">
													<h9><?php echo substr($item['ProductName'],0,30); ?></h9>


													<span class="head-font block text-warning font-16"><?php echo number_format($item['ProductPrice'],2);?></span>
												</div>
											</article>
										</div>
									</div>	
