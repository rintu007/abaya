				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Staff Salary</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Salary</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'salary/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
?>
												  <tr id="<?php echo $item['SalaryID'];?>">
													...
													<td class="text-nowrap">
														...
														<a href="<?php echo base_url().'salary/edit/'.$item['SalaryID']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i>
														</a> 

														<a href="#" onclick="DeleteItem(<?php echo $item['SalaryID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
		...
		function DeleteItem(id)
		{
			...
			swal({   
	            ...
	            closeOnCancel: false 
		            ...
		            if (isConfirm) {
		            	$.ajax({
					      url: '<?php echo base_url()."salary/delete";?>',
					      type: 'post',
					      data: { id: id},
