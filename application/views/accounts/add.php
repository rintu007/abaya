				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark"><?php echo ucfirst($mode); ?> Accounts</h5>
						</div>
						<!-- Breadcrumb -->
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form name="form one" method="post" action="<?php echo base_url().'accounts/'.$mode;?>">
													...
													<div class="row">
														<div class="col-sm-6">
															...
															<div class="form-group">
																...
																<input type="text" name="PaymentAccountName" id="PaymentAccountName" required="required" placeholder="Enter the Manufacture name" class="form-control"
																value="<?php echo isset($PaymentAccountName)?$PaymentAccountName:''; ?>" >
															</div>
															...
															<div class="col-sm-4 col-xs-12 mt-15">
																<input type="hidden" name="PaymentAccountID" id="PaymentAccountID" value="<?php echo isset($PaymentAccountID)?$PaymentAccountID:''; ?>">
																<button class="btn btn-primary  btn-rounded btn-block btn-anim"><i class="fa fa-check-square"></i><span class="btn-text"><?php echo ucfirst($mode); ?> Account</span></button>
															</div>
