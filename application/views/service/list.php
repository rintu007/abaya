			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <a href="<?php echo base_url().'service?view=grid'; ?>">
							<div class="pull-left"><i class="fa  fa-th mr-5"></i><span class="right-nav-text">Service</span></div>
						</a>
					</div>
					<!-- Breadcrumb -->
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Service</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'service/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
?>														
													...
													<td><?php echo $item['TaxName']; ?></td>

													<td><?php echo number_format($item['ServicePrice'],2); ?></td>

													<td>
<?php 								if($item['ServiceActive'] == 1)
									{
?>
...
?>			
													...
													<td class="text-nowrap">
														...
														<a href="<?php echo base_url().'service/edit/'.$item['ServiceID']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> 
														</a> 

														<a href="#" onclick="DeleteItem(<?php echo $item['ServiceID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
