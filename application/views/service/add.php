				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark"><?php echo ucfirst($mode); ?> Service</h5>
						</div>
						<!-- Breadcrumb -->
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form name="form one" method="post" action="<?php echo base_url().'service/'.$mode;?>" enctype="multipart/form-data">
													...
													<div class="row">
														<div class="col-sm-6">
															...
															<div class="form-group">
																...
																<input type="text" name="ServiceName" id="ServiceName" required="required" placeholder="Enter Service name" class="form-control"
																value="<?php echo isset($ServiceName)?$ServiceName:''; ?>" >
															</div>
															...
															<div class="form-group">
																<label class="control-label mb-10 text-left">Service Price</label>
																<input type="number" name="ServicePrice" id="ServicePrice" required="required" placeholder="Enter Price" class="form-control"
																value="<?php echo isset($ServicePrice)?$ServicePrice:''; ?>" >
															</div>
															...
															<div class="panel-wrapper collapse in">
																<div class="panel-body">
																	<label class="control-label mb-1">Service Image</label>
																	<div class="mt-20">
<?php
...
?>
															...
															<div class="form-group">
																...
																<div class="form-group">
																<label class="control-label mb-10">With Free Service</label>
																<select class="form-control" name="WFServiceID" id="WFServiceID"  >
...
<?php
													...
													{
?>
																	<option value="<?php echo $SRV['ServiceID']; ?>" <?php echo (isset($WFServiceID) && $WFServiceID == $SRV['ServiceID'])?'selected':''; ?> ><?php echo $SRV['ServiceName']; ?></option>
<?php
													}
?>
																</select>
...
?>											
															<div class="form-group">
																<div class="checkbox checkbox-success">
																	<input id="ServiceActive" name="ServiceActive" type="checkbox" value="1" <?php echo (isset($ServiceActive) && $ServiceActive == 1)?'checked':''; ?>>
																	<label for="ServiceActive"> Service Active </label>
																</div>
															</div>
<?php 									}
?>																
															...
															<div class="col-sm-2 col-xs-6 mt-15">
																<input type="hidden" name="ServiceID" id="ServiceID" value="<?php echo isset($ServiceID)?$ServiceID:''; ?>">
																<input type="hidden" name="ImageID" id="ImageID" value="<?php echo isset($ImageID)?$ImageID:''; ?>">
																<button class="btn btn-primary  btn-rounded btn-block btn-anim"><i class="fa fa-check-square"></i><span class="btn-text"><?php echo ucfirst($mode); ?> Service</span></button>
															</div>



															<div class="col-sm-2 col-xs-6 mt-15">
																<a class="btn btn-danger  btn-rounded btn-block btn-anim" href="<?php echo base_url().'service'; ?>"><i class="fa fa-minus-circle"></i><span class="btn-text">Cancel</span></a>
															</div>
