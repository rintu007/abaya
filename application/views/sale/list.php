			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							...
							<div class="pull-left"><i class="fa  fa-th mr-5"></i><span class="right-nav-text">Sale</span></div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Sales</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'sale/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
<?php 					$count = 0;
						foreach($items as $item)
						{
							$count++;
?>
												  <tr id="<?php echo $item['SaleID'];?>">
													<td onclick="ShowSale(<?php echo $item['SaleID'];?>);" style="cursor: pointer;"><?php echo $item['ReferenceNo']; ?></td>
													<td onclick="ShowSale(<?php echo $item['SaleID'];?>);" style="cursor: pointer;"><?php echo $item['CustomerName']; ?></td>
													<td onclick="ShowSale(<?php echo $item['SaleID'];?>);" style="cursor: pointer;"><?php echo date('d-m-Y',strtotime($item['SaleDate'])); ?></td>
													<td onclick="ShowSale(<?php echo $item['SaleID'];?>);" style="cursor: pointer;"><?php echo number_format($item['TotalAmount'],2); ?></td>

                                                      <td onclick="ShowSale(<?php echo $item['SaleID'];?>);" style="cursor: pointer;">
...
?>
													...
													<td class="text-nowrap">
                                                        ...
                                                        <a href="#" onclick="TotalAmountClick(<?php echo $item['SaleID']; ?>);" data-toggle="tooltip" class="mr-25" > <i class="fa fa-dollar text-success "></i> </a>

														<a href="<?php echo base_url().'sale/edit/'.$item['SaleID']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> 
														</a> 

														<a href="#" onclick="DeleteItem(<?php echo $item['SaleID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
...
?>
	...
	<script type="text/javascript">
        ...
        function TotalAmountClick(SaleID)
        {
            $.ajax({
                url: '<?php echo base_url()."sale/view_payment_list";?>',
                type: 'post',
                data: { SaleID: SaleID},
		...
		function ShowSale(SaleID)
		{
			...
			$.ajax({
		      url: '<?php echo base_url()."sale/view_sale_ajax";?>',
		      type: 'post',
		      data: { SaleID: SaleID},
		      success: function(data) {
