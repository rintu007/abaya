...
<br>
						<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="panel panel-default card-view" id="AdvanceDiv" style="display: none">
										<div class="panel-heading">
											<div class="pull-left">
												<h6 class="panel-title txt-dark">Customer Advance</h6>
											</div>
										...
										<div class="panel-wrapper collapse in">
											<div class="panel-body row pa-0" id="AdvanceContent">
								...
								<div class="col-sm-2 pull-right">
									...
									<button class="btn btn-default  btn-rounded btn-block btn-anim" type="button" onclick="SubmitForm();"><i class="fa fa-check-square"></i><span class="btn-text">Submit</span></button>
			...
			function CheckOrder()
			{
				...
				$.ajax({
			      ...
			      success: function(data) {
					...
					//for advance
				$.ajax({
			      url: '<?php echo base_url()."sale/search_advance";?>',
			      type: 'post',
			      data: { CustomerID: CustomerID },
			      success: function(data) {
						if(data != 0)
	      				{
	      					...
	      					let SelectTable	='<table class="table table-hover display  pb-30" > <thead><th>Reference No</th><th>Date</th><th>Amount</th></thead>';
				      		...
				      		for(let i=0; i< obj.length; i++)
				      		{
				      			let CheckBox =	'';
				      			//check the item already in or out
					      		CheckBox = '<input type="checkbox" name="PaymentID" id="PaymentID'+obj[i].PaymentID+'" value="'+obj[i].PaymentID+'" >';
				      			...
				      			//console.log(obj.Batchs[i].ProductBatchID);
				      			SelectTable	+='<tr><td ><div class="form-group"><div class="checkbox checkbox-primary">'+CheckBox+
				      			'<label for="PaymentID'+obj[i].PaymentID+'">'+obj[i].ReferenceNo+'</label></div>	</div></td>'+
				      			'<td>'+obj[i].PaymentDate+'</td> <td>'+Amount+' </td>'+				      			
				      			'</tr> ';
			      			...
			      			$('#AdvanceContent').html(SelectTable);
