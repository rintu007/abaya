							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
				<form name="form one" method="post" action="<?php echo base_url().'sale/update';?>" id="PurchaseForm" >
...
?>		
													<tr id="MU<?php echo $Item['ItemSl'];?>">
														<input type="hidden" name="ItemType[<?php echo $Item['ItemSl'];?>]" id="ItemType<?php echo $Item['ItemSl'];?>" value="<?php echo $Item['ItemType'];?>" >
										      			<input type="hidden" name="ProductID[<?php echo $Item['ItemSl'];?>]" id="ProductID<?php echo $Item['ItemSl'];?>" value="<?php echo $Item['ProductID'];?>" >	
										      			<input type="hidden" name="OrderItemID[<?php echo $Item['ItemSl'];?>]" id="OrderItemID<?php echo $Item['ItemSl'];?>" value="<?php echo $Item['OrderItemID'];?>" >	
										      			...
										      			<input type="hidden" name="CheckOrderItem[<?php echo $Item['OrderItemID'];?>]" id="CheckOrderItem<?php echo $Item['OrderItemID'];?>" value="<?php echo $Item['OrderItemID'];?>" >				      			
														...
														<input type="hidden" name="TaxRate[<?php echo $Item['ItemSl'];?>]" id="TaxRate<?php echo $Item['ItemSl'];?>" value="<?php echo $Item['TaxRate'];?>"  >
														<input type="hidden" name="TaxMethod[<?php echo $Item['ItemSl'];?>]" id="TaxMethod<?php echo $Item['ItemSl'];?>" value="<?php echo $Item['TaxMethod'];?>"  >
														...
														<td> <?php echo $UnitsName;?></td>
														<td style="width: 10%;"><input style="text-align: right;" type="text" class="form-control" id="Rate<?php echo $Item['ItemSl'];?>" name="Rate[<?php echo $Item['ItemSl'];?>]"  
															required="required" value="<?php echo number_format($Item['Rate'],2,'.', '');?>" onkeyup="PriceChange(<?php echo $Item['ItemSl'];?>);"></td>
														...
														<td style="width: 10%;"><input style="text-align: right;background-color: #fff;" type="text" class="form-control" id="TaxValue<?php echo $Item['ItemSl'];?>" name="TaxValue[<?php echo $Item['ItemSl'];?>]" 
															value="<?php echo number_format($Item['TaxValue'],2,'.', '');?>" readonly ></td>
														<td style="width: 10%;"><input style="text-align: right;" type="text" class="form-control" id="Amount<?php echo $Item['ItemSl'];?>" name="Amount[<?php echo $Item['ItemSl'];?>]" 
															value="<?php echo number_format($Item['Amount'],2,'.', '');?>" required="required" onkeyup="PriceChange(<?php echo $Item['ItemSl'];?>,2);"></td>
													</tr>
...
?>														
						...
						<div class="col-sm-3">
							<div class="input-group has-primary">
				                ...
				                <input type="text" class="form-control" id="Total" name="Total" readonly style="font-size:15px; font-weight: bold;text-align:right;background-color: #fff;" value="<?php echo number_format($Total,2,'.', ''); ?>">
				              </div>
				          </div>
				          ...
				          <div class="col-sm-3">
							<div class="input-group has-primary">
				                ...
				                <input type="text" class="form-control" id="TaxAmount" name="TaxAmount" onkeyup="GrandTotal();" style="font-size:13px; font-weight: bold;;text-align:right;" value="<?php echo number_format($TaxAmount,2,'.', ''); ?>">
				              </div>
				          </div>
				        ...
				        <div class="col-sm-3">
							<div class="input-group has-primary">
				                ...
				                <input type="text" class="form-control" id="Discount" name="Discount" onkeyup="GrandTotal();" style="font-size:13px; font-weight: bold;;text-align:right;" value="<?php echo number_format($Discount,2,'.', ''); ?>">
				              </div>
				          </div>
				          ...
				          <div class="col-sm-3">
							<div class="input-group has-primary">
				                ...
				                <input type="text" class="form-control" id="TotalAmount" name="TotalAmount" readonly style="font-size:15px; font-weight: bold;text-align:right;background-color: #fff;" value="<?php echo number_format($TotalAmount,2,'.', ''); ?>">
				              </div>
				          </div>
...
<script type="text/javascript">
            ...
            function TotalAmountClick()
            {
                ...
                $.ajax({
                    url: '<?php echo base_url()."sale/view_payment";?>',
                    type: 'post',
                    data: { SaleID: SaleID},
                    success: function(data) {
