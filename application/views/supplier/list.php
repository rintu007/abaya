					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Supplier</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'supplier/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
<?php 					$count = 0;
						foreach($items as $item)
						{
							$count++;
?>
												  <tr id="<?php echo $item['SupplierID'];?>">
													<td>
<?php
...
?>														
													...
													<td><?php echo $item['SupplierPhone']; ?></td>
													<td><?php echo $item['SupplierEmail']; ?></td>


													<td>
<?php 								if($item['SupplierActive'] == 1)
									{
?>
...
?>													</td>
													...
													<td class="text-nowrap">
														...
														<a href="<?php echo base_url().'supplier/edit/'.$item['SupplierID']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a> 

														<a href="#" onclick="DeleteItem(<?php echo $item['SupplierID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
