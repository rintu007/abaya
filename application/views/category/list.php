			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Product Category</h5>
					</div>
					<!-- Breadcrumb -->
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Product Category</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'category/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
<?php 					$count = 0;
						foreach($items as $item)
						{
							$count++;
?>
												  <tr id="<?php echo $item['CategoryID'];?>">
													<td><?php echo $count; ?></td>
													<td><?php echo $item['CategoryName']; ?></td>
													<td class="text-nowrap">

														<a href="<?php echo base_url().'category/edit/'.$item['CategoryID']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a> 

														<a href="#" onclick="DeleteItem(<?php echo $item['CategoryID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
