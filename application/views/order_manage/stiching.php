			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Stiching</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="<?php echo base_url(); ?>">Dashboard</a></li>
						<li class="active"><span>Stiching Orders</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Stiching Orders</h6>
								</div>
...
?>														
													...
													<td onclick="ChangeAssign(<?php echo $item['OrderItemID'];?>,<?php echo $item['StaffID'];?>);" style="cursor: pointer;"><?php echo $item['StaffName']; ?></td>
													...
													<td > <button onclick="MakeReady(<?php echo $item['OrderItemID'];?>);" class="btn btn-success btn-icon-anim "><i class="icon-rocket"></i>
...
?>
	...
	<script type="text/javascript">
		...
		function ChangeAssign(OrderItemID,StaffID)
		{
			//$('#OFModalContent').html('Order Form ID is '+OrderFormID);

				$.ajax({
			      url: '<?php echo base_url()."order_manage/change_assign";?>',
			      type: 'post',
			      data: { OrderItemID: OrderItemID,StaffID: StaffID},
			      success: function(data) {
			      	$('#OFModalContent').html(data);
			      	$('#OFModal').modal('toggle');
			      },
		...
		function MakeReady(OrderItemID)
		{
			//$('#OFModalContent').html('Order Form ID is '+OrderFormID);

			swal({   
	            title: "Are you sure?",   
	            text: "Do you want to complete the stiching ",   
	            type: "warning",   
	            ...
	            closeOnCancel: false 
		            ...
		            if (isConfirm) {
		            		...
		            		window.location.replace("<?php echo base_url().'order_manage/make_ready/';?>"+OrderItemID);
