...
?>														
													...
													<td > <button onclick="ShowAssign(<?php echo $item['OrderItemID'];?>);" class="btn btn-success btn-icon-anim btn-square"><i class="icon-rocket"></i></button></td>
...
?>
	...
	<script type="text/javascript">
		...
		function ShowAssign(OrderItemID)
		{
			//$('#OFModalContent').html('Order Form ID is '+OrderFormID);

				$.ajax({
			      url: '<?php echo base_url()."order_manage/view_assign";?>',
			      type: 'post',
