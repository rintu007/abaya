			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Ready</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="<?php echo base_url(); ?>">Dashboard</a></li>
						<li class="active"><span>Ready Orders</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Ready Orders</h6>
								</div>
...
<?php
											...
											{
?>													<button  class="btn btn-success btn-icon-anim " title="Delivered on <?php echo date('d-m-Y',strtotime($item['DeliveredDate'])); ?>">
...
?>
													<button onclick="MakeDeliver(<?php echo $item['OrderItemID'];?>);" class="btn btn-primary btn-icon-anim "><i class="icon-rocket"></i>
...
?>
	...
	<script type="text/javascript">
		...
		function MakeDeliver(OrderItemID)
		{
			//$('#OFModalContent').html('Order Form ID is '+OrderFormID);

			swal({   
	            title: "Are you sure?",   
	            text: "Do you want to Deliver this item",   
	            type: "warning",   
	            ...
	            closeOnCancel: false 
		            ...
		            if (isConfirm) {
		            		...
		            		window.location.replace("<?php echo base_url().'order_manage/make_deliver/';?>"+OrderItemID);
