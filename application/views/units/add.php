				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark"><?php echo ucfirst($mode); ?> Product Units</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li><a href="<?php echo base_url().'units'; ?>"><span>Product Units</span></a></li>
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form name="form one" method="post" action="<?php echo base_url().'units/'.$mode;?>">

													<div class="row">
														<div class="col-sm-6">

															<div class="form-group">
																<label class="control-label mb-10 text-left">Units Name</label>
																<input type="text" name="UnitsName" id="UnitsName" required="required" placeholder="Enter the Units name" class="form-control"
																value="<?php echo isset($UnitsName)?$UnitsName:''; ?>" >
															</div>
															...
															<div class="col-sm-4 col-xs-12 mt-15">
																<input type="hidden" name="UnitsID" id="UnitsID" value="<?php echo isset($UnitsID)?$UnitsID:''; ?>">
																<button class="btn btn-primary  btn-rounded btn-block btn-anim"><i class="fa fa-check-square"></i><span class="btn-text"><?php echo ucfirst($mode); ?> Units</span></button>
															</div>



															<div class="col-sm-4 col-xs-12 mt-15">
																<a class="btn btn-danger  btn-rounded btn-block btn-anim" href="<?php echo base_url().'units'; ?>"><i class="fa fa-minus-circle"></i><span class="btn-text">Cancel</span></a>
															</div>
