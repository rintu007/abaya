			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							...
							<div class="pull-left"><i class="fa  fa-th mr-5"></i><span class="right-nav-text">Purchase</span></div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Purchase</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'purchase/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
<?php 					$count = 0;
						foreach($items as $item)
						{
							$count++;
?>
												  <tr id="<?php echo $item['PurchaseID'];?>">
													<td onclick="ShowPurchase(<?php echo $item['PurchaseID'];?>);" style="cursor: pointer;"><?php echo $item['ReferenceNo']; ?></td>
													<td onclick="ShowPurchase(<?php echo $item['PurchaseID'];?>);" style="cursor: pointer;"><?php echo $item['SupplierName']; ?></td>
													<td onclick="ShowPurchase(<?php echo $item['PurchaseID'];?>);" style="cursor: pointer;"><?php echo $item['WarehouseName']; ?></td>
 ...
 <?php                                                   $BalanceAmount = $item['TotalAmount']-$item['PaidAmount'];
													...
													<td class="text-nowrap">
														...
														<a href="#" onclick="DeleteItem(<?php echo $item['PurchaseID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
...
?>
	...
	<script type="text/javascript">
		...
		function ShowPurchase(PurchaseID)
		{
			...
			$.ajax({
		      url: '<?php echo base_url()."purchase/view_purchase_ajax";?>',
		      type: 'post',
		      data: { PurchaseID: PurchaseID},
		      success: function(data) {
