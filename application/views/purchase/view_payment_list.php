...
?>
											...
											<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														<h5 class="modal-title" >Payments of <?php echo $SupplierName; ?></h5>
													</div>
...
<script type="text/javascript">
		...
		function MakeNewPayment(PurchaseID,SupplierID,ReferenceNo)
		{
			//alert(PurchaseID);
            $.ajax({
                url: '<?php echo base_url()."purchase/add_payment_list";?>',
                type: 'post',
		...
		function InsertPayment(PurchaseID)
		{
		   // alert(PurchaseID)
            ...
            $.ajax({
                url: '<?php echo base_url()."purchase/insert_payment_list";?>',
                type: 'post',
