			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <a href="<?php echo base_url().'design?view=grid'; ?>">
							<div class="pull-left"><i class="fa  fa-th mr-5"></i><span class="right-nav-text">Design</span></div>
						</a>
					</div>
					<!-- Breadcrumb -->
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">List Design</h6>
								</div>
								<div class="pull-right">			
									<a href="<?php echo base_url().'design/add'; ?>"><div class="pull-left"><i class="fa fa-plus-square mr-5"></i><span class="right-nav-text">New</span></div></a>
								</div>
...
?>														
													...
													<td><?php echo number_format($item['DesignPrice'],2); ?></td>

													<td>
<?php 								if($item['DesignActive'] == 1)
									{
?>
...
?>													</td>									
													<td class="text-nowrap">
														...
														<a href="<?php echo base_url().'design/edit/'.$item['DesignID']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> 
														</a> 

														<a href="#" onclick="DeleteItem(<?php echo $item['DesignID']; ?>);" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
												  </tr>
<?php 					}
						if($count == 0)
						{
