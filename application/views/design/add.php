				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark"><?php echo ucfirst($mode); ?> Design</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li><a href="<?php echo base_url().'design'; ?>"><span>Design</span></a></li>
							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form name="form one" method="post" action="<?php echo base_url().'design/'.$mode;?>" enctype="multipart/form-data">
													...
													<div class="row">
														<div class="col-sm-6">
															...
															<div class="form-group">
																<label class="control-label mb-10 text-left">Design Name</label>
																<input type="text" name="DesignName" id="DesignName" required="required" placeholder="Enter name" class="form-control"
																value="<?php echo isset($DesignName)?$DesignName:''; ?>" >
															</div>

															<div class="form-group">
																<label class="control-label mb-10">Service</label>
...
<?php
													...
													{
?>
																	<option value="<?php echo $Cat['ServiceID']; ?>" <?php echo (isset($ServiceID) && $ServiceID == $Cat['ServiceID'])?'selected':''; ?> >
																	<?php echo $Cat['ServiceName']; ?></option>
<?php
													}
?>
																</select>
															...
															<div class="form-group">
																<label class="control-label mb-10 text-left">Design Price</label>
																<input type="number" name="DesignPrice" id="DesignPrice"  placeholder="Enter Price" class="form-control"
																value="<?php echo isset($DesignPrice)?$DesignPrice:''; ?>" >
															</div>


															<div class="panel-wrapper collapse in">
																<div class="panel-body">
																	<label class="control-label mb-1">Design Image</label>
																	<div class="mt-20">
<?php
...
?>											
															<div class="form-group">
																<div class="checkbox checkbox-success">
																	<input id="DesignActive" name="DesignActive" type="checkbox" value="1" <?php echo (isset($DesignActive) && $DesignActive == 1)?'checked':''; ?>>
																	<label for="DesignActive"> Design Active </label>
																</div>
															</div>
<?php 									}
?>																
															...
															<div class="col-sm-2 col-xs-6 mt-15">
																<input type="hidden" name="DesignID" id="DesignID" value="<?php echo isset($DesignID)?$DesignID:''; ?>">
																<input type="hidden" name="ImageID" id="ImageID" value="<?php echo isset($ImageID)?$ImageID:''; ?>">
																<button class="btn btn-primary  btn-rounded btn-block btn-anim"><i class="fa fa-check-square"></i><span class="btn-text"><?php echo ucfirst($mode); ?> Design</span></button>
															</div>



															<div class="col-sm-2 col-xs-6 mt-15">
																<a class="btn btn-danger  btn-rounded btn-block btn-anim" href="<?php echo base_url().'design'; ?>"><i class="fa fa-minus-circle"></i><span class="btn-text">Cancel</span></a>
															</div>
