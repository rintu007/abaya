...
class product extends CI_Controller 
{
	...
	public function add()
	{
		...
		else
		{
			...
			$data['Manufactures']	=	$this->m_product->view_manufacture();
			$data['Units']		=	$this->m_product->view_units();
	...
	public function edit($ProductID)
	{
		...
		$data['Manufactures']	=	$this->m_product->view_manufacture();
		$data['Units']		=	$this->m_product->view_units();
		$data['MUS']		=	$this->m_product->view_mu($ProductID);
		$data['Tax']		=	$this->m_product->view_tax();
		$data['title']	=	'Product';
		$data['mode']	=	'update';
		$this->load->view('product/add',$data);
	...
	public function delete_mu()
	{
		$ProductMUID 	=	$_POST['ProductMUID'];
		$result =	$this->m_product->delete_mu($ProductMUID);
		echo $result;
	}

	function add_mu_ajax()
	{
		$ProductMUID	=	 $this->m_product->add_multi_unit($_POST);
		$UnitName		=	$this->m_product->multi_unit_unitname($ProductMUID);
		echo json_encode(array('ProductMUID'=>$ProductMUID,'UnitName'=>$UnitName));
	}
}
